			...
			stop: function(event, ui) {
				...
				*/
				...
				if($("#reglas_de_negocio").has("#perioricidad_recurrente").length){
					...
					//$("#perioricidad_recurrente").css({"height":"100px"});
					$("#perioricidad_recurrente").css({"padding":"10px 10px 100px 10px"});
...
<div style="width:100%; background:#DCDCDC; height:800px;">
	<div style="float:left; width:30%; height:100%;">
        ...
        <div id="accordion">
        	...
        	<h3 style="background:#1ecbc8;">L&oacute;gicas</h3>
        	<div style="background:#1ecbc8;">
        		<div class="contenedor_regla_negocio" id="perioricidad_recurrente">
        			...
        			<div id="perioricidad_recurrente_detalle" style="display:none;">
        				...
        				<input type="text" value="500.00" id="caida_libre_valor_1" />
        				metros de altura
        				=
        				<span id="caida_libre_resultado"></span> segundos en llegar al piso
        				<input type="hidden" value="" id="caida_libre_tiempo" />
        				con una velocidad final de 
        				<span id="caida_libre_velocidad_resultado"></span> m/s
        				<span id="caida_libre_velocidad_kmh_resultado"></span> k/h
        				<!-- 
        				<input type="button" value="Calcular" onclick="$('#caida_libre_resultado').html(parseInt($('#caida_libre_valor_1').val()) / 9.8  );" />
        				h = 1/2g x t2
        				...
        				<input type="button" value="Calcular" onclick="$('#caida_libre_resultado').html((2 * parseInt($('#caida_libre_valor_1').val())) / -9.81  );" />
        				<input type="button" value="Calcular" onclick="$('#caida_libre_resultado').html((Math.sqrt(2) * parseInt($('#caida_libre_valor_1').val())) / -9.81  );" />
        				<input type="button" value="Calcular" onclick="$('#caida_libre_resultado').html((2 * Math.sqrt(parseInt($('#caida_libre_valor_1').val()))) / 9.81  );" />
        				<input type="button" value="Calcular" onclick="$('#caida_libre_resultado').html((Math.sqrt(2)) * parseInt($('#caida_libre_valor_1').val()) / 9.8  );" />
        				<input type="button" value="Calcular" onclick="$('#caida_libre_resultado').html(((Math.sqrt(2) * parseInt($('#caida_libre_valor_1').val())) / 9.8  ));" />
        				-->
        				<script>
        				//Altura en metros
						function caida_libre(altura){
							var tiempo_caida = Math.sqrt((2 * parseInt(altura)) / 9.8  ));
							//var velocidad_final_caida = ;
							
							//$('#caida_libre_velocidad_resultado').html(velocidad_final_caida);
							//alert($('#caida_libre_resultado').val()
							
						}

        				</script>
        				<!-- 
        				<input type="button" value="Calcular" onclick="caida_libre($('#caida_libre_valor_1').val());" />
        				<input type="button" value="Calcular" onclick="$('#caida_libre_resultado').html(Math.sqrt(2 * 9.8 * parseInt($('#caida_libre_valor_1').val()))); $('#caida_libre_velocidad_resultado').html(Math.sqrt(2 * 9.8 * parseInt($('#caida_libre_valor_1').val())));" />
        				<input type="button" value="Calcular" onclick="$('#caida_libre_resultado').html(Math.sqrt((2 * parseInt($('#caida_libre_valor_1').val())) / 9.8  )); $('#caida_libre_velocidad_resultado').html(Math.sqrt(2 * 9.8 * parseInt($('#caida_libre_valor_1').val())));" />
        				-->
        				<input type="button" value="Calcular" onclick="$('#caida_libre_resultado').html(Math.sqrt((2 * parseInt($('#caida_libre_valor_1').val())) / 9.8  )); $('#caida_libre_velocidad_resultado').html(Math.sqrt(2 * 9.8 * parseInt($('#caida_libre_valor_1').val())));  $('#caida_libre_velocidad_kmh_resultado').html(((Math.sqrt(2 * 9.8 * parseInt($('#caida_libre_valor_1').val()))) * 3600) / 1000)" />
