        	...
        	<div style="background:#1ecbc8;">
        		<div class="contenedor_regla_negocio" id="perioricidad_recurrente">
        			...
        			<div id="perioricidad_recurrente_detalle" style="display:none;">
        				...
        				<span id="caida_libre_velocidad_resultado"></span> con una velocidad final
        				<!-- 
        				...
        				<input type="button" value="Calcular" onclick="$('#caida_libre_resultado').html(Math.sqrt((2 * parseInt($('#caida_libre_valor_1').val())) / 9.8  )); alert($('#caida_libre_resultado').val())" />
