	...
	<head>
		...
		*/
		...
		@keyframes mymove4 {
			...
			20%   {background: -webkit-gradient(linear, left top, left bottom, from(#ccc), to(#000)); width: 20%;}
			40%   {background: radial-gradient(#7B7878 1%, #BBBBBB 30%, #CCCCCC 40%, #FFF 70%); width: 40%;}
			60%   {background:radial-gradient(circle, #D52B48, #413636); width: 60%;}
			80%   {background: #0039bf; width: 80%;}
		    100% {background: #8500bf; width: 100%;}
		}
